...
moduleForModel('i-i-s-umnyjj-dom-управляющая-компания', 'Unit | Serializer | i-i-s-umnyjj-dom-управляющая-компания', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-umnyjj-dom-управляющая-компания',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
